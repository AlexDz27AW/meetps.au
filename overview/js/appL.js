...
(function () {
    ...
    btn.on('click', function () {
        ...
        var video = pWrap.find('.js-video'),
            text = pWrap.find('.js-video-text'),
            wrap = pWrap.find('.js-video-wrap');
...
// Replace Lick on mobile devices
(function () {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
        $("a[href$='-full']").each(function () {
            var oldUrl = $(this).attr("href");
            var newUrl = oldUrl.replace("-full", "m-full");
...
})(window, document, 'script', 'dataLayer', 'GTM-TLT3HV5');
