...
<head>
    ...
    <![endif]-->
    <script type="text/javascript" src="http://localhost/meet/wp-includes/js/utm.js"></script>
    <script>
...
<div class="out">
        ...
        <div class="top__center center">
            ...
            <div class="top__wrap">
                ...
                <a class="top__item top__item_m top__item_entry" href="#" data-popup=".js-popup-sm">
                    <div class="top__icon"><svg class="icon icon-entry"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-entry"></use></svg></div>
        ...
        <div class="main__center center">
                    ...
                    <div class="header__wrap">
                        ...
                        <a class="header__logo logo logo_white" href="/">
                            ...
                            <div class="logo__wrap">
                                <div class="logo__icon"><svg class="icon icon-logo"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-logo"></use></svg></div>
            ...
            <div class="main__list">
                <div class="main__item">
                    <div class="main__icon"><svg class="icon icon-main-1"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-main-1"></use></svg></div>
                    <div class="main__text">Meetings <br>& town halls</div>
                </div>
                <div class="main__item">
                    <div class="main__icon"><svg class="icon icon-main-2"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-main-2"></use></svg></div>
                    <div class="main__text">Conferences <br>& events</div>
                </div>
                <div class="main__item">
                    <div class="main__icon"><svg class="icon icon-main-3"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-main-3"></use></svg></div>
                    <div class="main__text">Livestreams <br>& broadcasts</div>
                </div>
                <div class="main__item">
                    <div class="main__icon"><svg class="icon icon-main-4"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-main-4"></use></svg></div>
    ...
    <div class="partners">
        <div class="partners__center center">
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-1.png" width="130px"></div>
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-2.png" width="121px"></div>
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-3.png" width="110px"></div>
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-4.png" width="135px"></div>
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-5.png" width="133px"></div>
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-6.png" width="150px"></div>
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-7.png" width="73px"></div>
            <div class="partners__item"><img class="partners__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-8.png" width="135px"></div>
        </div>
    </div>
    <!-- conection-->
    <div id="features"></div>
                ...
                <div class="quality__row">
                    <div class="quality__col">
                        <a class="quality__link-to-feature" href="/features#qa-section">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-1"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-1"></use></svg></div>
                        ...
                        <a class="quality__link-to-feature" href="/features#polls-section">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-2"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-2"></use></svg></div>
                                <div class="quality__info">
                        ...
                        <a class="quality__link-to-feature" href="/features#pulse-section">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-3"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-3"></use></svg></div>
                                <div class="quality__info">
                        ...
                        <a class="quality__link-to-feature" href="/features#raffles-section">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-4"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-4"></use></svg></div>
                                <div class="quality__info">
                    ...
                    <div class="quality__col">
                        <a class="quality__link-to-feature" href="/features#security-section">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-5"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-5"></use></svg></div>
                                <div class="quality__info">
                        ...
                        <a class="quality__link-to-feature" href="/features">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-6"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-6"></use></svg></div>
                                <div class="quality__info">
                        ...
                        <a class="quality__link-to-feature" href="/features">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-7"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-7"></use></svg></div>
                                <div class="quality__info">
                        ...
                        <a class="quality__link-to-feature" href="/features">
                            <div class="quality__item">
                                <div class="quality__icon"><svg class="icon icon-quality-8"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-quality-8"></use></svg></div>
                                <div class="quality__info">
            ...
            <div class="technology__row">
                <div class="technology__col">
                    <div class="technology__item">
                        <div class="technology__icon"><svg class="icon icon-technology-1"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-technology-1"></use></svg></div>
                    ...
                    <div class="technology__item">
                        <div class="technology__icon"><svg class="icon icon-technology-2"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-technology-2"></use></svg></div>
                        <div class="technology__wrap">
                    ...
                    <div class="technology__item">
                        <div class="technology__icon"><svg class="icon icon-technology-3"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-technology-3"></use></svg></div>
                        <div class="technology__wrap">
                ...
                <div class="technology__col">
                    <div class="technology__item">
                        <div class="technology__icon"><svg class="icon icon-technology-4"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-technology-4"></use></svg></div>
                        <div class="technology__wrap">
                    ...
                    <div class="technology__item">
                        <div class="technology__icon"><svg class="icon icon-technology-5"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-technology-5"></use></svg></div>
                        <div class="technology__wrap">
                    ...
                    <div class="technology__item">
                        <div class="technology__icon"><svg class="icon icon-technology-6"><use xlink:href="http://localhost/meet/wp-content/themes/meetingpulse/img/sprite.svg#icon-technology-6"></use></svg></div>
                        <div class="technology__wrap">
    ...
    <div id="clients"></div>
    <div class="company">
        <div class="company__video"><video autoplay muted loop><source src="http://localhost/meet/wp-content/themes/meetingpulse/video/iStock-514252612.mp4" type="video/mp4"><source src="http://localhost/meet/wp-content/themes/meetingpulse/video/iStock-514252612.webm" type="video/webm"><source src="video/iStock-514252612.ogv" type="video/ogg"></video></div>
        <div class="company__bg"></div>
        <div class="company__container">
            <div class="company__center center">
                <div class="company__list">
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-1.png" width="150px"></div>
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-2.png" width="123px"></div>
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-3.png" width="115px"></div>
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-4.png" width="141px"></div>
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-5.png" width="139px"></div>
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-6.png" width="148px"></div>
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-7.png" width="76px"></div>
                    <div class="company__item"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-8.png" width="137px"></div>
                </div>
                ...
                <div class="company__row">
                    <div class="company__col">
                        <div class="company__wrap">
                            <div class="company__logo"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-2.png" width="141px"></div>
                        </div>
                    ...
                    <div class="company__col">
                        <div class="company__wrap">
                            <div class="company__logo"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-3.png" width="141px"></div>
                    ...
                    <div class="company__col">
                        <div class="company__logo"><img class="company__pic" src="http://localhost/meet/wp-content/themes/meetingpulse/img/partners-w-4.png" width="166px"></div>
