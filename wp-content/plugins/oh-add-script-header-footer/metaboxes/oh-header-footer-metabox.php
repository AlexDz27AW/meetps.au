        ...
        <table width="100%">
            <tr>
                <td valign="top">
                    ...
                    <p>
                        <label for="oh_add_script_header_hide">
                            ...
                            <?php _e("Hide Generic Footer scrip", 'oh_add_script'); ?>
                ...
                <td width="250">
                    ...
                    <p><a target='_blank' href='https://pluginsmarket.com/downloads/sogo-header-footer/'><img style="max-width: 100%; height: auto"
                                                                         src='images/300-250.jpg'
                                                                         alt='Sogo Web Development'/></a></p>
                    <p>
                        <?php _e("Upgrade now to a premium version and remove the ads!", 'oh_add_script'); ?>
                        <a class="button-primary" href="https://pluginsmarket.com/downloads/sogo-header-footer/"> <?php _e("Upgrade now", 'oh_add_script'); ?></a>
                    </p>
