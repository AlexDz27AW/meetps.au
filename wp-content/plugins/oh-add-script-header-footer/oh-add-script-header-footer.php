...
function oh_add_script()
{
	...
	if ( oh_show_me_on( 'oh_posttype' ) && get_post_meta( $id, '_oh_add_script_header_hide', true ) != 'on' ) {
...
function oh_add_script_footer()
{
	...
	if ( oh_show_me_on( 'oh_posttype_footer' ) && get_post_meta( $id, '_oh_add_script_footer_hide', true ) != 'on' ) {
		$sogo_header_footer = get_option( 'sogo_header_footer' );
